...
def main():
    ...
    parser.add_argument('--qf')  # "blind", 5, or 90
    args = parser.parse_args()

    L_path = args.input_dir
    E_path = args.output_dir
    model_pool = args.weight_dir
    qf = args.qf
    ...
    for idx, img in enumerate(L_paths):
        ...
        if qf == 'blind':
            ...
            util.imsave(img_E, os.path.join(E_path, f"output.png"))
        ...
        #    from IPython import embed; embed()
            ...
            img_E = util.tensor2single(img_E)
            img_E = util.single2uint(img_E)
            util.imsave(img_E, os.path.join(E_path, 'output.png'))
